...
from ops_translate.intent.merge import detect_conflicts, smart_merge
            ...
            "data": {
                "intent": {
                    ...
                    "inputs": {
                        ...
                        "memory_gb": {"type": "integer", "required": False, "default": 8},
                    },
                }
            },
        },
...
def test_smart_merge_uses_most_restrictive_quotas():
    ...
    intents = [
        {
            "file": "file1.yaml",
            "data": {"intent": {"governance": {"quotas": {"max_cpu": 16, "max_memory_gb": 64}}}},
        },
        {
            "file": "file2.yaml",
            "data": {"intent": {"governance": {"quotas": {"max_cpu": 32, "max_memory_gb": 128}}}},
        },
    ]
...
def test_smart_merge_uses_max_compute():
    ...
    intents = [
        {
            "file": "file1.yaml",
            "data": {"intent": {"compute": {"cpu_cores": 4, "memory_gb": 16, "disk_gb": 100}}},
        },
        {
            "file": "file2.yaml",
            "data": {"intent": {"compute": {"cpu_cores": 8, "memory_gb": 32, "disk_gb": 200}}},
        },
    ]
...
def test_smart_merge_uses_mixed_for_different_workload_types():
    ...
    intents = [
        {"file": "file1.yaml", "data": {"intent": {"workload_type": "virtual_machine"}}},
        {"file": "file2.yaml", "data": {"intent": {"workload_type": "container"}}},
    ]
            ...
            "data": {
                "intent": {
                    "metadata": {
                        ...
                        "labels": {"managed-by": "ops-translate"},
                    }
                }
            },
        },
            ...
            "data": {
                "intent": {
                    "metadata": {
                        ...
                        "labels": {"managed-by": "ops-translate", "backup-policy": "daily"},
                    }
                }
            },
        },
...
def test_detect_conflicts_no_false_positives():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        intent_data = {"intent": {"workflow_name": "same_name", "workload_type": "virtual_machine"}}
...
def test_detect_conflicts_reports_real_differences():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        file1.write_text(
            yaml.dump({"intent": {"workflow_name": "name1", "compute": {"cpu_cores": 4}}})
        )

        file2.write_text(
            yaml.dump({"intent": {"workflow_name": "name2", "compute": {"cpu_cores": 8}}})
        )
